...
texto = """
Hola, soy Camila. Cuando comencé a programar, me sentí abrumada por la cantidad de conceptos nuevos que debía aprender. Recuerdo mi primera vez intentando escribir un programa simple en Python. Pasé horas buscando errores en mi código, sin entender por qué no funcionaba como esperaba. Pero cada pequeño avance era una victoria. Con paciencia y perseverancia, fui entendiendo mejor la lógica detrás de la programación. Cada error corregido era un paso más hacia mi meta de dominar este nuevo lenguaje. Con el tiempo, esos momentos de frustración se convirtieron en pequeños hitos de aprendizaje que me motivaron a seguir adelante. Ahora, mirando hacia atrás, puedo ver cuánto he crecido desde entonces y cuánto más confiada me siento frente a nuevos desafíos en el mundo de la programación.
"""
...
texto_2 = """
Este proceso de aprendizaje en la programación no solo me ha enseñado habilidades técnicas, sino también habilidades de resolución de problemas, perseverancia y creatividad. Cada día, continúo explorando y expandiendo mis conocimientos, emocionada por lo que el futuro en este campo tiene reservado para mí.
"""
...
sidebar.markdown("Acá se pueden obsevar los gráficos de la PC3", unsafe_allow_html=True)
...
graficos = ['Gráfica1', 'Gráfica2', 'Gráfica3']
...
if grafico_seleccionado == 'Gráfica1':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Se puede observar un gráfico de barras de la cantidad de lenguas por familias</div>", unsafe_allow_html=True)
    sidebar.image("Gráfica1.png", caption='Gráfico1', width=500)
    pass
elif grafico_seleccionado == 'Gráfica2':
    sidebar.markdown("<div style='text-align: justify'>Se puede observar un mapa con la información de las familias linguisticas en América Latina", unsafe_allow_html=True)
    sidebar.image("Gráfica2.png", caption='Gráfico2', width=500)
    pass
elif grafico_seleccionado == 'Gráfica3':
    sidebar.markdown("<div style='text-align: justify'>Se puede observar un gráfico de barras del número de lenguas por familia linguistica", unsafe_allow_html=True)
    sidebar.image("Gráfica3.png", caption='Gráfico3', width=500)
    pass
